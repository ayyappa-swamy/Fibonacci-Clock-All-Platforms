...
import logging
logger = logging.getLogger('fibclock_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by FibclockWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseFibclockWindow object.
        """
        builder = get_builder('FibclockWindow')
        new_object = builder.get_object("fibclock_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a FibclockWindow object with it in order to finish
        initializing the start of the new FibclockWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.fibclock")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('fibclock')
        except ImportError:
            pass
        ...
        try:
            from fibclock import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for fibclock."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for fibclock."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the FibclockWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the FibclockWindow is closed."""
